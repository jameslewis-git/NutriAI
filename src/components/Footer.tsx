      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-500 max-w-xs">
              Smart nutrition planning that optimizes your diet while respecting your budget.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li><a href="#" className="text-sm text-gray-600 hover:text-primary">Meal Planning</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-primary">Budget Optimization</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-primary">Nutrition Tracking</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-primary">Grocery Lists</a></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <p className="text-sm text-gray-400 text-center">
            &copy; {new Date().getFullYear()} NutriPlan AI. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
